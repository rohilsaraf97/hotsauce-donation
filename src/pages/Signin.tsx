    ...
    <div>
      <div className="h-13 sticky top-0 z-50 flex flex-row items-center justify-between bg-white p-5 shadow-xl">
        ...
        <div className="flex flex-row items-center ">
          ...
          <button
            className="ml-2 mb-2 rounded bg-yellow-300 px-5 py-2.5 text-center text-sm font-medium text-black hover:bg-yellow-500 focus:outline-none focus:ring-4 focus:ring-yellow-300 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900"
            type="button"
            onClick={() => handleAuth()}
          >
      ...
      <div className="flex flex-row items-center justify-center">
        <div className="flex w-8/12 flex-col justify-start p-20 ">
          <Heading
            text="CryptoCares: A different approach to donations"
            headingStyle="text-yellow-300 text-6xl font-bold "
          />
          <p className="font-xl mt-10 text-xl text-black">
            Our goal is to enable charities and NGOs to provide help and support
            to those in need. We aim to use blockchain technology to ensure
            secure and transparent transactions. Donate MATIC using our portal
            and help us spread the awareness and importance of donations using
            Cryptocurrency.
          </p>
        </div>
      ...
      <div className="flex flex-col items-center p-20">
        <Heading
          ...
          headingStyle="text-black text-5xl font-bold "
        />
      ...
      <div className="flex w-full flex-row items-center justify-between bg-slate-200 p-20">
        <InfoBox
      ...
      <div className="flex flex-col px-20 pt-5 pb-5">
        <Heading
          text="What is MetaMask?"
          headingStyle="text-yellow-300 p-10 text-left text-5xl font-bold "
        />

        <p className="font-xl w-6/12  w-full p-10 text-justify text-xl text-black">
